...
DOC_WRAPPER = textwrap.TextWrapper( #    width=COL_LIMIT,  #  2012 May 23
    expand_tabs = True, replace_whitespace = True, initial_indent = NULL,
                                   subsequent_indent = NULL,
                                   fix_sentence_endings = False,
                                   break_long_words = True,) # 2007 May 25
SUBSTITUTE_FOR = {'abday_1': 'ABDAY_1', 'abday_2': 'ABDAY_2', 'abday_3':
                  'ABDAY_3', 'abday_4': 'ABDAY_4', 'abday_5': 'ABDAY_5',
                  'abday_6': 'ABDAY_6', 'abday_7': 'ABDAY_7', 'abmon_1':
                  'ABMON_1', 'abmon_10': 'ABMON_10', 'abmon_11': 'ABMON_11',
                  'abmon_12': 'ABMON_12', 'abmon_2': 'ABMON_2', 'abmon_3':
                  'ABMON_3', 'abmon_4': 'ABMON_4', 'abmon_5': 'ABMON_5',
                  'abmon_6': 'ABMON_6', 'abmon_7': 'ABMON_7', 'abmon_8':
                  'ABMON_8', 'abmon_9': 'ABMON_9', 'accel_group': 'AccelGroup',
                  'action_default': 'ACTION_DEFAULT', 'action_copy':
                  'ACTION_COPY', 'align_left': 'ALIGN_LEFT', 'align_right':
                  'ALIGN_RIGHT', 'align_center': 'ALIGN_CENTER', 'alignment':
                  'Alignment', 'button_press': 'BUTTON_PRESS',
                  'button_press_mask': 'BUTTON_PRESS_MASK', 'buttons_cancel':
                  'BUTTONS_CANCEL', 'can_default': 'CAN_DEFAULT', 'can_focus':
                  'CAN_FOCUS', 'cell_renderer_pixbuf': 'CellRendererPixbuf',
                  'cell_renderer_text': 'CellRendererText', 'check_button':
                  'CheckButton', 'child_nodes': 'childNodes', 'color': 'Color',
                  'config_parser': 'ConfigParser', 'cursor': 'Cursor', 'day_1':
                  'DAY_1', 'day_2': 'DAY_2', 'day_3': 'DAY_3', 'day_4': 'DAY_4',
                  'day_5': 'DAY_5', 'day_6': 'DAY_6', 'day_7': 'DAY_7',
                  'dest_default_all': 'DEST_DEFAULT_ALL', 'dialog_modal':
                  'DIALOG_MODAL', 'dict_reader': 'DictReader', 'dict_writer':
                  'DictWriter', 'dir_tab_forward': 'DIR_TAB_FORWARD', 'dotall':
                  'DOTALL', 'dotall': 'DOTALL', 'enter_notify_mask':
                  'ENTER_NOTIFY_MASK', 'error': 'Error', 'event_box': 'EventBox',
                  'expand': 'EXPAND', 'exposure_mask': 'EXPOSURE_MASK',
                  'file_selection': 'FileSelection', 'fill': 'FILL', 'ftp':
                  'FTP', 'get_attribute': 'getAttribute', 'gtk.button': 'Button',
                  'gtk.combo': 'Combo', 'gtk.dialog': 'Dialog', 'gtk.entry':
                  'Entry', 'pixmap': 'Pixmap', 'gtk.image': 'Image', 'gtk.label':
                  'Label', 'gtk.menu': 'Menu', 'gtk.pack_end': 'PACK_END',
                  'gtk.pack_start': 'PACK_START', 'gtk.vbox': 'VBox',
                  'gtk.window': 'Window', 'hand2': 'HAND2', 'hbox': 'HBox',
                  'icon_size_button': 'ICON_SIZE_BUTTON', 'icon_size_dialog':
                  'ICON_SIZE_DIALOG', 'icon_size_dnd': 'ICON_SIZE_DND',
                  'icon_size_large_toolbar': 'ICON_SIZE_LARGE_TOOLBAR',
                  'icon_size_menu': 'ICON_SIZE_MENU', 'icon_size_small_toolbar':
                  'ICON_SIZE_SMALL_TOOLBAR', 'image_menu_item': 'ImageMenuItem',
                  'item_factory': 'ItemFactory', 'justify_center':
                  'JUSTIFY_CENTER', 'justify_fill': 'JUSTIFY_FILL',
                  'justify_left': 'JUSTIFY_LEFT', 'justify_right':
                  'JUSTIFY_RIGHT', 'list_item': 'ListItem', 'list_store':
                  'ListStore', 'menu_bar': 'MenuBar', 'message_dialog':
                  'MessageDialog', 'message_info': 'MESSAGE_INFO', 'mon_1':
                  'MON_1', 'mon_10': 'MON_10', 'mon_11': 'MON_11', 'mon_12':
                  'MON_12', 'mon_2': 'MON_2', 'mon_3': 'MON_3', 'mon_4': 'MON_4',
                  'mon_5': 'MON_5', 'mon_6': 'MON_6', 'mon_7': 'MON_7', 'mon_8':
                  'MON_8', 'mon_9': 'MON_9', 'multiline': 'MULTILINE',
                  'node_type': 'nodeType', 'notebook': 'Notebook', 'o_creat':
                  'O_CREAT', 'o_excl': 'O_EXCL', 'o_ndelay': 'O_NDELAY',
                  'o_rdwr': 'O_RDWR', 'p_nowait': 'P_NOWAIT', 'parsing_error':
                  'ParsingError', 'pointer_motion_mask': 'POINTER_MOTION_MASK',
                  'pointer_motion_hint_mask': 'POINTER_MOTION_HINT_MASK',
                  'policy_automatic': 'POLICY_AUTOMATIC', 'policy_never':
                  'POLICY_NEVER', 'radio_button': 'RadioButton', 'realized':
                  'REALIZED', 'relief_none': 'RELIEF_NONE', 'request': 'Request',
                  'response_cancel': 'RESPONSE_CANCEL', 'response_delete_event':
                  'RESPONSE_DELETE_EVENT', 'response_no': 'RESPONSE_NO',
                  'response_none': 'RESPONSE_NONE', 'response_ok': 'RESPONSE_OK',
                  'response_yes': 'RESPONSE_YES', 'scrolled_window':
                  'ScrolledWindow', 'shadow_in': 'SHADOW_IN', 'sniffer':
                  'Sniffer', 'sort_ascending': 'SORT_ASCENDING',
                  'sort_descending': 'SORT_DESCENDING', 'state_normal':
                  'STATE_NORMAL', 'stock_add': 'STOCK_ADD', 'stock_apply':
                  'STOCK_APPLY', 'stock_bold': 'STOCK_BOLD', 'stock_cancel':
                  'STOCK_CANCEL', 'stock_close': 'STOCK_CLOSE', 'stock_convert':
                  'STOCK_CONVERT', 'stock_copy': 'STOCK_COPY', 'stock_cut':
                  'STOCK_CUT', 'stock_dialog_info': 'STOCK_DIALOG_INFO',
                  'stock_dialog_info': 'STOCK_DIALOG_INFO',
                  'stock_dialog_question': 'STOCK_DIALOG_QUESTION',
                  'stock_execute': 'STOCK_EXECUTE', 'stock_find': 'STOCK_FIND',
                  'stock_find_and_replace': 'STOCK_FIND_AND_REPLACE',
                  'stock_go_back': 'STOCK_GO_BACK', 'stock_go_forward':
                  'STOCK_GO_FORWARD', 'stock_help': 'STOCK_HELP', 'stock_index':
                  'STOCK_INDEX', 'stock_jump_to': 'STOCK_JUMP_TO', 'stock_new':
                  'STOCK_NEW', 'stock_no': 'STOCK_NO', 'stock_ok': 'STOCK_OK',
                  'stock_open': 'STOCK_OPEN', 'stock_paste': 'STOCK_PASTE',
                  'stock_preferences': 'STOCK_PREFERENCES',
                  'stock_print_preview': 'STOCK_PRINT_PREVIEW', 'stock_quit':
                  'STOCK_QUIT', 'stock_refresh': 'STOCK_REFRESH', 'stock_remove':
                  'STOCK_REMOVE', 'stock_save': 'STOCK_SAVE', 'stock_save_as':
                  'STOCK_SAVE_AS', 'stock_yes': 'STOCK_YES', 'string_io':
                  'StringIO', 'style_italic': 'STYLE_ITALIC', 'sunday': 'SUNDAY',
                  'tab': 'Tab', 'tab_array': 'TabArray', 'tab_left': 'TAB_LEFT',
                  'table': 'Table', 'target_same_app': 'TARGET_SAME_APP',
                  'target_same_widget': 'TARGET_SAME_WIDGET', 'text_iter':
                  'TextIter', 'text_node': 'TEXT_NODE', 'text_tag': 'TextTag',
                  'text_view': 'TextView', 'text_window_text':
                  'TEXT_WINDOW_TEXT', 'text_window_widget': 'TEXT_WINDOW_WIDGET',
                  'text_wrapper': 'TextWrapper', 'tooltips': 'Tooltips',
                  'tree_view': 'TreeView', 'tree_view_column': 'TreeViewColumn',
                  'type_string': 'TYPE_STRING', 'underline_single':
                  'UNDERLINE_SINGLE', 'weight_bold': 'WEIGHT_BOLD',
                  'window_toplevel': 'WINDOW_TOPLEVEL', 'wrap_none': 'WRAP_NONE',
                  'wrap_word': 'WRAP_WORD',}
...
def wrap_lines(lines, width, # 2012 May 23
...
class OutputUnit(object):
    ...
    def line_more(self, chunk = NULL, tab_set = False, tab_clear = False,
                  can_split_str = False, can_split_after = False,
                  can_break_after = False,): # 2007 Mar 06
        self.chunks.append([chunk, tab_set, tab_clear, can_split_str,
                           can_split_after, can_break_after,])
        self.col += len(chunk)
        return self
    ...
    def line_term(self, pause = False): # 2007 May 25
        ...
        def is_split_needed(cumulative_width):
            pos = self.pos
            return ((pos + cumulative_width) > COL_LIMIT) and (pos > ZERO) #
            # 2007 May 01
        ...
        chunk_lengths = []
        self.chunks.reverse()
        for (chunk, tab_set, tab_clear, can_split_str, can_split_after,
             can_break_after,) in self.chunks: # 2007 May 01
            if (can_split_after or can_break_after):
                cumulative_width = ZERO
            cumulative_width += len(chunk)
            chunk_lengths.insert(ZERO,[chunk, cumulative_width, tab_set,
                                 tab_clear, can_split_str, can_split_after,
                                 can_break_after,])
        for (chunk, cumulative_width, tab_set, tab_clear, can_split_str,
             can_split_after, can_break_after,) in chunk_lengths: # 2007 May 01
    ...
    def put(self, text): # 2006 Dec 14
        ...
        if (self.buffer.endswith('\n') or self.buffer.endswith('\r')): # 2008
        # Jan 30
    ...
    def __init__(self):
                    ...
                    if prev_token_type in [tokenize.STRING]:
                        ...
                        while (True):
                            ...
                            if next_token_type in [tokenize.STRING]:
                                if prev_token_string[ - 1] == next_token_string[
                                                                                ZERO]:
        ...
        for (token_type, token_string, start, end, line) in lines:
            ...
            if token_type in [tokenize.COMMENT, tokenize.NL]:
                ...
                original = original.replace('\t', DOC_TAB_REPLACEMENT) # 2007
                # May 24
                ...
                if (SHEBANG_PATTERN.match(original) is not None):
                    ...
                    original = COMMENT_PATTERN.sub(NULL, original, 1) # 2007
                    # May 25
                ...
                try:
                    ...
                    if ((encoded == original) or (encoded == force_quote(original,
                        ...
                        original = quote_original(token_type, original) # 2007
                        # May 01
                        original_values = \
                            self.literal_pool.setdefault(encoded,[]) # 2010 Mar
                            # 10
...
#                        OUTPUT.put_blank_line(2)
        ...
        if (text and LEFTJUST_DOC_STRINGS): # 2007 May 25
            (first, last, is_first_blank, is_last_blank) = strip_blank_lines(
                                                                             text)
        ...
        for (scol, line) in text: # 2007 May 25
            if (scol == NA):
                ...
                if ((margin_string == '# ') and (line.startswith('#'))): # 2010
                # Mar 10
...
class Name(list): # 2006 Dec 14
    ...
    def rept_collision(self, key):
        ...
        if (len(self) == 1):
            ...
            sys.stderr.write(
                             "Error:  %s ambiguously replaced by '%s' at line %i.\n" % (
    ...
    def rept_external(self, expr):
        ...
        if expr in ['self', 'cls']:
            ...
            sys.stderr.write(
                             "Warning:  '%s.%s,' defined elsewhere, replaced by '.%s' at line %i.\n" % (
...
def transform(indent, lineno, node):
    ...
    *compiler* module to objects with *put* methods.
    ...
    if (isinstance_(node, 'Add')):
        ...
        result = NodeCallFunc(indent, lineno, node.node, node.args,
        ...
        result = NodeFunction(indent, lineno, getattr(node, 'decorators', None),
                              node.name, node.argnames, node.defaults,
                              node.flags, node.doc, node.code,)
    elif (isinstance_(node, 'GenExpr')):
        result = NodeGenExpr(indent, lineno, node.code)
    elif (isinstance_(node, 'GenExprFor')):
        result = NodeGenExprFor(indent, lineno, node.assign, node.iter, node.ifs)
        ...
        result = NodeSubscript(indent, lineno, node.expr, node.flags, node.subs)
...
class Node(object):
    ...
    def line_more(self, chunk = NULL, tab_set = False, tab_clear = False,
        ...
        OUTPUT.line_more(chunk, tab_set, tab_clear, can_split_str,
                         can_split_after, can_break_after,)
        return self
...
class NodeInt(Node):
    ...
    def get_as_repr(self):
        original_values = COMMENTS.literal_pool.get(repr(self.int),[]) # 2010
        # Mar 10
        if (len(original_values) == 1):
            (result, lineno) = original_values[ZERO]
        else:
...
class NodeAdd(NodeOprAssoc): # 2010 Mar 10
    ...
    def put(self, can_split = False):
        ...
        self.line_more(SPACE, can_split_after = can_split, can_break_after =
                       True) # 2007 May 23
        self.line_more('+ ')
...
class NodeConst(Node):
    ...
    def get_as_repr(self): # 2007 May 01
        original_values = COMMENTS.literal_pool.get(repr(self.value),[]) # 2010
        # Mar 10
        if (len(original_values) == 1):
            (result, lineno) = original_values[ZERO]
        else:
...
class NodeDict(Node):
    ...
    def __init__(self, indent, lineno, items):
        Node.__init__(self, indent, lineno)
        self.items = [(transform(indent, lineno, key), transform(indent, lineno,
...
class NodeDiv(NodeOprLeftAssoc): # 2010 Mar 10
    ...
    def put(self, can_split = False):
        self.put_expr(self.left, can_split = can_split, pos = 'left') # 2010
        # Mar 10
        self.line_more(SPACE, can_split_after = can_split, can_break_after =
                       True) # 2007 May 23
        self.line_more('/ ')
        self.put_expr(self.right, can_split = can_split, pos = 'right') # 2010
        # Mar 10
        return self
...
class NodeFunction(Node):
    ...
    def __init__(self, indent, lineno, decorators, name, argnames, defaults,
                 flags, doc, code,):
...
class NodeLambda(NodeFunction):
    ...
    def __init__(self, indent, lineno, argnames, defaults, flags, code):
        NodeFunction.__init__(self, indent, lineno, None, None, argnames,
                              defaults, flags, None, code,)
        return
...
class NodeTryExcept(Node):
    ...
    def __init__(self, indent, lineno, body, handlers, else_):
        ...
        self.handlers = [(transform(indent, lineno, expr), transform(indent,
                         lineno, target), transform(indent + 1, lineno, suite))
                         for (expr, target, suite) in handlers]
        self.else_ = transform(indent + 1, lineno, else_)
    ...
    def put(self, can_split = False, is_paren_required = True): # 2010 Mar 10
        if (len(self.nodes) > MAX_SEPS_SERIES): # 2007 May 24
            ...
            if (JAVA_STYLE_LIST_DEDENT): # 2010 Sep 08
                ...
                self.dec_margin()
            self.line_more(')', tab_clear = True) # 2010 Mar 10
        elif ((len(self.nodes) == ZERO) or is_paren_required or
...
OPERATOR_PRECEDENCE = [(NodeIfExp,),(NodeLambda,),(NodeOr,),(NodeAnd,),(NodeNot,),(
                       NodeCompare,),(NodeBitOr,),(NodeBitXor,),(NodeBitAnd,),(
                       NodeLeftShift, NodeRightShift),(NodeAdd, NodeSub),(
                       NodeMul, NodeDiv, NodeFloorDiv, NodeMod),(NodeUnaryAdd,
                       NodeUnarySub, NodeInvert,), # 2010 Mar 10
    (NodePower,),(NodeAsgAttr, NodeGetAttr),(NodeSubscript,),(NodeSlice,),(
                       NodeCallFunc,),(NodeTuple,),(NodeList,),(NodeDict,),(
                       NodeBackquote,),]
OPERATORS = []
OPERATOR_TRUMPS = {}
OPERATOR_LEVEL = {}
